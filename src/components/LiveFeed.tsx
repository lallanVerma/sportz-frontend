...
export const LiveFeed: React.FC<LiveFeedProps> = ({
  ...
  if (!isActive) {
     ...
     console.log('❌ LiveFeed not showing - isActive is false');
    return (
  ...
  // console.log('✅ LiveFeed active, messages:', messages.length);
          ...
          messages.map((msg) => {
            ...
            const metadataLabel =
              typeof msg.metadata === "string"
                ...
                : msg.metadata;
            // console.log("metadata: ", metadataLabel, typeof metadataLabel);
            // console.log(msg);
            const tags = Array.isArray(msg.tags)
              ? msg.tags
              : typeof msg.tags === "string"
                ? msg.tags
                    .replace(/[{}"]/g, "")
                    .split(",")
                    .map((tag) => tag.trim())
                  ...
                  <div className="pb-4">
                    ...
                    {metadataLabel && (
                      <div className="mt-3 flex flex-wrap gap-2">
                        {Object.entries(metadataLabel).map(([key, value]) => (
                          <div
                            key={key}
                            className="flex items-center gap-1 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-xs shadow-sm"
                          >
